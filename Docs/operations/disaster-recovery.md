...
- **Application state**: NeuronDesktop/NeuronAgent (in neuron-desktop and neuron-agent repos) store minimal state in DB; backup the DB. Config and secrets are in env or Vault; document restore steps.
