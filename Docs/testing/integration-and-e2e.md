...
- For deeper E2E tests, add scripts under `tests/e2e/` (or in **neuron-desktop** repo under `tests/e2e/`) that drive the API and optionally the UI (e.g. Playwright) and assert on responses and DB state.
