...
- **[NeuronAgent](https://github.com/neurondb/neuron-agent)** - Agent runtime
- **[NeuronMCP](https://github.com/neurondb/neuron-mcp)** - MCP server
- **[NeuronDesktop](https://github.com/neurondb/neuron-desktop)** - Web interface
