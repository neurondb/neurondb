...
```bash
# Clean and rebuild
docker-compose -f docker/docker-compose.yml build --no-cache neurondb
...
- Validate compose file: `docker-compose -f docker/docker-compose.yml config`
