...
|-----------|--------|--------|
| `default_version` | `4.0.0-devel` | Version installed by `CREATE EXTENSION neurondb` when no version is specified |
...
ALTER EXTENSION neurondb UPDATE TO '4.0.0-devel';
```
